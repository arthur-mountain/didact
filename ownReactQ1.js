  ...
  */
  ...
  function reconcileChildren(wipFiber, elements) {
    ...
    while (index < elements.length || oldFiber != null) {
      ...
      if (element && !sameType) { // add this new node
        newFiber = {
          type: element.type,
          props: element.props,
          dom: null,
      ...
      // Question: 為什麼這裡同時 iterator,
      // 這裡的 pointer 為何會是 oldFiber = oldFiber.sibling
      if (oldFiber) {
